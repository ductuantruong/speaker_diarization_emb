...
if __name__ == "__main__":
    ...
    parser.add_argument('--list-path', dest='list_path', default="data/Eval_Ali/Eval_Ali_far", required=False)
    parser.add_argument('--wav-path', dest='wav_path', default="data/Eval_Ali/Eval_Ali_far/audio_dir", required=False)
    parser.add_argument('--output-path', dest='output_path', default="data/Eval_Ali/Eval_Ali_far",  required=False)
